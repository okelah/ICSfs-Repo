...
/**
 * SimpleExample demonstrates use of the Morena Framework in both application and applet environment. Upload
 * action cant be used if it is invoked from local filesystem.
 *
        ...
        private class AcquireImageAction extends AbstractAction implements TransferListener {
            ...
            public synchronized void actionPerformed(ActionEvent event) {
                try {
                    ...
                    if (device != null) {
                        System.out.println("is device Scanner? " + (device instanceof Scanner));
                        System.out.println("is device Camera? " + (device instanceof Camera));
                    ...
                    JOptionPane.showMessageDialog(MainPanel.this, exception.toString(), "Error",
        ...
        private class ImagePanel extends JPanel {
            ...
            public void paint(Graphics g) {
                ...
                if (horizontalRatio > verticalRatio) {
                    ...
                    g.drawImage(image, 3, 3, (int) (imageWidth * horizontalRatio),
