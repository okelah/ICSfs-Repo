 ...
 * 
 * This software is the confidential and proprietary information of Gnome spol. s r.o. You shall not disclose
 * such Confidential Information and shall use it only in accordance with the terms of the license agreement
 * you entered into with Gnome.
 */
...
/**
 * Helper class that encapsulates a synchronization of the scanning process. Provided methods returns either
 * BufferedImage or File containing an image.
 *
...
public class SynchronousHelper {
    ...
    /**
     * TransferDoneListener interface implementation that handles a scanned document as BufferedImage.
     * 
     */
    ...
    static class FileTransferHandler implements TransferDoneListener {
         ...
         * note that this method runs in different thread than that where the device.startTransfer() has been
         * called.
         * 
    ...
    /**
     * Convenient method that starts scanning process on specified device from default functional unit (0) and
     * returns a scanned document as a BufferedImage. Device driver UI is displayed according showUI
     * parameter.
     * 
     * @param device
     * @param showUI
    ...
    /**
     * Convenient method that starts scanning process on specified device from specified functional unit (0,
     * 1, ...) and returns a scanned document as a BufferedImage. Device driver UI is displayed according
     * showUI parameter.
     * 
     * @param device
     * @param showUI
    ...
    /**
     * Convenient method that starts scanning process on specified device from default functional unit (0) and
     * returns a scanned document as a File. Device driver UI is displayed according showUI parameter.
     * 
     * @param device
     * @param showUI
    ...
    /**
     * Convenient method that starts scanning process on specified device from specified functional unit (0,
     * 1, ...) and returns a scanned document as a File. Device driver UI is displayed according showUI
     * parameter.
     * 
     * @param device
     * @param item - scanner's functional unit (flatbed, document feeder, ...) number
     * @param showUI
     * @return - File containing an image of the scanned document
     * @throws Exception
     */
